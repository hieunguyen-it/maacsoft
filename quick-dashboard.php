...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Quick Dashboard</title>
		...
		<div class="page-wrapper pinned">
						...
						<ul>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										<li>
											<a href="index.html" class="current-page">Dashboard tổng hợp</a>
										</li>
										<li>
											<a href="project-dashboard.html">Quản lý dự án</a>
										</li>
										<li>
											<a href="sales-dashboard.html">Quản trị bán hàng</a>
										</li>
										<li>
											<a href="crm-dashboard.html">Báo cáo CRM</a>
										</li>
										<li>
											<a href="ecommerce-dashboard.html">Báo cáo bán hàng</a>
										</li>

										<li>
											<a href="smart-dashboard.html">Báo cáo thông minh</a>
										</li>
									</ul>
								</div>
							</li>
							...
							<li class="sidebar-dropdown">
								...
								<div class="sidebar-submenu">
									<ul>
										<li>
											<a href="default-layout.html">Giao diện mặc định</a>
										</li>
										<li>
											<a href="default-dark-layout.html">Giao diện Dark</a>
										</li>
										<li>
											<a href="fixed-layout.html">Giao diện cố định</a>
										</li>
										<li>
											<a href="fixed-layout-dark.html">Giao diện cố định Dark</a>
										</li>
										<li>
											<a href="slim-sidebar.html">Giao diện slim</a>
										</li>
										<li>
											<a href="slim-sidebar-dark.html">Giao diện Slim Dark</a>
										</li>
										<li>
											<a href="card-options.html">Tuỳ chọn thẻ</a>
										</li>
										<li>
											<a href="drag-drop-cards.html">Thẻ kéo và thả</a>
										</li>
									</ul>
								</div>
							</li>
							<li class="sidebar-dropdown">
								...
								<div class="sidebar-submenu">
									<ul>
										<li>
											<a href="account-settings.html">Cài đặt Account</a>
										</li>
										<li>
							...
							<li class="sidebar-dropdown">
								...
								<div class="sidebar-submenu">
									<ul>
										<li>
											<a href="form-inputs.html">Form nhập liệu</a>
										</li>
										<li>
											<a href="input-groups.html">Nhập liệu nhóm</a>
										</li>
										<li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						<li class="breadcrumb-item">Dashboards</li>
						<li class="breadcrumb-item active">Quick Dashboard</li>
					</ol>
