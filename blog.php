...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>MAAC ANALYSIS - Blog</title>
					...
					<div class="row gutters">
						<div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12">
							...
							<div class="row gutters">
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="blog">
										<img class="blog-img" src="img/bg1.jpeg" alt="Card image cap">
										<div class="blog-body">
											...
											<div class="blog-description">
												<p>Wafi is a responsive admin dashboard template for admin and back end applications. It is a reliable, user-friendly and easy to customize. Wafi comes with a huge collection of plugins and UI components that makes your work easy. This is a longer card with supporting text below as a natural lead-in to additional content.</p>
											</div>
								...
								<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
									<div class="blog">
										<img class="blog-img" src="img/img7.jpg" alt="Card image cap">
										<div class="blog-body">
											...
											<div class="blog-description">
												<p>Wafi is a responsive admin dashboard template for admin and back end applications.</p>
											</div>
											<div class="blog-actions">
												<a href="blog-article.html" class="btn btn-primary">Keep Reading</a>
												<div class="actions">
								...
								<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
									<div class="blog">
										<img class="blog-img" src="img/img9.jpg" alt="Card image cap">
										<div class="blog-body">
						...
						<div class="col-xl-3 col-lg-12 col-md-12 col-sm-12 col-12">
							...
							<div class="row gutters">
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="blog">
										<img class="blog-img" src="img/bg2.jpeg" alt="Card image cap">
										<div class="blog-body">
											<p>Wafi is a responsive admin dashboard template for admin and back end applications.</p>
											<div class="blog-actions">
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="categories">
												...
												<span class="badge badge-dark">Chat</span>
												<span class="badge badge-dark">Dashboard</span>
												<span class="badge badge-dark">Scss</span>
												<span class="badge badge-dark">Calendar</span>
												<span class="badge badge-dark">Horizontal Menu</span>
												<span class="badge badge-dark">Profile</span>
												<span class="badge badge-dark">Invoice</span>
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="popular-posts">
												<a href="#">
													<img src="img/img2.jpg" class="post-img" alt="Wafi Blog Post" />
													<div class="post-content">
														<h6 class="post-title">Wafi Admin Template</h6>
														<h6 class="post-date">
												...
												<a href="#">
													<img src="img/img4.jpg" class="post-img" alt="Wafi Blog Post" />
													<div class="post-content">
												...
												<a href="#">
													<img src="img/img8.jpg" class="post-img" alt="Wafi Blog Post" />
													<div class="post-content">
