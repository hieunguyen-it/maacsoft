...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Components - Labels &amp; Badges</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="labels-badges.html" class="current-page">Labels &amp; Badges</a>
										</li>
										<li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Labels &amp; Badges</li>
					</ol>
							...
							<div class="card">
								<div class="card-body text-center">
									<button type="button" class="btn btn-primary">
										Mails <span class="badge badge-white">5</span>
										<span class="sr-only">unread messages</span>
									</button>
									<button type="button" class="btn btn-secondary">
										Alerts <span class="badge badge-white">7</span>
										<span class="sr-only">unread messages</span>
									</button>
									<button type="button" class="btn btn-primary">
										Likes <span class="badge badge-pill badge-white">11</span>
										<span class="sr-only">unread messages</span>
									</button>
									<button type="button" class="btn btn-secondary">
										Sales <span class="badge badge-pill badge-white">925</span>
										<span class="sr-only">unread messages</span>
									</button>
								</div>
							</div>
