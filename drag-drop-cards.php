...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Drag and Drop Cards</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="drag-drop-cards.html" class="current-page">Drag and Drop Cards</a>
										</li>
									</ul>
								</div>
							</li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Drag and Drop Cards</li>
					</ol>
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
							<div class="card lobipanel-sortable">
								<div class="card-header">
									<div class="card-title">Drag here</div>
								</div>
								<div class="card-body">
									Drag and Drop Cards
								</div>
