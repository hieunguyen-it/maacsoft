...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - C3 Graphs</title>
	...
	<body>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">C3 Graphs</li>
					</ol>
				...
				<div class="main-container">
					...
					<div class="row gutters">
						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
							<div class="card">
								...
								<div class="card-body">
									<div id="pieChart" class="chart-height-md"></div>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
							<div class="card">
								...
								<div class="card-body">
									<div id="donutChart" class="chart-height-md"></div>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
							<div class="card">
								...
								<div class="card-body">
									<div id="pieChart1" class="chart-height-md"></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row gutters">
						<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Line Graph</div>
								</div>
								<div class="card-body">
									<div id="lineGraphOverview" class="chart-height-md"></div>
								</div>
							</div>
						</div>
						<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
							<div class="card">
								...
								<div class="card-body">
									<div id="splineSales" class="chart-height-md"></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row gutters">
						<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
							<div class="card">
								...
								<div class="card-body">
									<div id="lineGraph" class="chart-height-md"></div>
								</div>
							</div>
						</div>
						<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
							<div class="card">
								...
								<div class="card-body">
									<div id="stackedBarGraph" class="chart-height-md"></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row gutters">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Area Spline Graph</div>
								</div>
								<div class="card-body">
									<div id="areaSplineGraph" class="chart-height-md"></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row gutters">
						<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
							<div class="card">
								...
								<div class="card-body">
									<div id="scatterPlot" class="chart-height-md"></div>
								</div>
							</div>
						</div>
						<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Step Graph</div>
								</div>
								<div class="card-body">
									<div id="stepGraph" class="chart-height-md"></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row gutters">
						<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Spline Graph</div>
								</div>
								<div class="card-body">
									<div id="splineGraph" class="chart-height-md"></div>
								</div>
							</div>
						</div>
						<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
							<div class="card">
								...
								<div class="card-body">
									<div id="barAreaGraph" class="chart-height-md"></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row gutters">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="card">
								...
								<div class="card-body">
									<div id="barGraph" class="chart-height-md"></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row gutters">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="card m-0">
								...
								<div class="card-body">
									<div id="serverRequests" class="chart-height-sm"></div>
								</div>
							</div>
						</div>
					</div>
		...
		************* -->
		...
		<script src="vendor/c3/custom/line-graph.js"></script>
		<script src="vendor/c3/custom/spline-graph.js"></script>
		<script src="vendor/c3/custom/area-spline-graph.js"></script>
		<script src="vendor/c3/custom/step-graph.js"></script>
		<script src="vendor/c3/custom/bar-area-graph.js"></script>
		<script src="vendor/c3/custom/bar-graph.js"></script>
		<script src="vendor/c3/custom/stacked-bar-braph.js"></script>
		<script src="vendor/c3/custom/scatter-plot.js"></script>
		<script src="vendor/c3/custom/pie-chart.js"></script>
		<script src="vendor/c3/custom/pie-chart-one.js"></script>
		<script src="vendor/c3/custom/donut-chart.js"></script>
		<script src="vendor/c3/custom/server-requests.js"></script>
		<script src="vendor/c3/custom/spline-sales.js"></script>
		<script src="vendor/c3/custom/line-graph-overview.js"></script>
		<script src="vendor/c3/custom/line-graph-one.js"></script>
