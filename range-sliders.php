...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Range Sliders</title>
				...
				<div class="main-container">
					...
					<div class="row gutters">
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Min value, max value and start point</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Without params</div>
								</div>
								<div class="card-body">
									...
									*************************-->
									...
									<input type="text" id="range_01" name="example_name" value="70" />
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Double and specify range</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Range with negative values</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Range with step 250</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Range with fractional values, using fractional step</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Set up you own numbers</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Using any strings as your values</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">One more example with strings</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">No prettify. Big numbers are ugly and unreadable</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Prettify enabled. Much better!</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Don't like space as separator? Use anything you like!</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">You don't like default prettify function? Use your own!</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Using prefixes</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Using postfixes</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Want to show that max number is not the biggest one?</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Taking care about how from and to values connect? Use decorate_both option:</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Remove double decoration</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Use your own separator symbol with values_separator option. Like →</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Disable all the sliders visual details</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Hide any part you wish</div>
								</div>
								<div class="card-body">
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">And some more</div>
								</div>
								<div class="card-body">
