...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Chat App</title>
															...
															<div class="usersContainerScroll">
																<ul class="users">
																	...
																	<li class="person" data-chat="person1">
																		<div class="user">
																			<img src="img/user6.png" alt="Wafi Admin" />
																	...
																	<li class="person active-user" data-chat="person1">
																		<div class="user">
																			<img src="img/user22.png" alt="Wafi Admin" />
																			<span class="status online"></span>
																		</div>
																		<p class="name-time">
																	...
																	<li class="person" data-chat="person2">
																		<div class="user">
																			<img src="img/user24.png" alt="Wafi Admin" />
																	...
																	<li class="person" data-chat="person3">
																		<div class="user">
																			<img src="img/user12.png" alt="Wafi Admin" />
																			<span class="status busy"></span>
																		</div>
																		<p class="name-time">
																	...
																	<li class="person" data-chat="person4">
																		<div class="user">
																			<img src="img/user14.png" alt="Wafi Admin" />
																	...
																	<li class="person" data-chat="person5">
																		<div class="user">
																			<img src="img/user7.png" alt="Wafi Admin" />
																			<span class="status away"></span>
																		</div>
																		<p class="name-time">
																	...
																	<li class="person" data-chat="person3">
																		<div class="user">
																			<img src="img/user9.png" alt="Wafi Admin" />
																			<span class="status busy"></span>
																		</div>
																		<p class="name-time">
																	...
																	<li class="person" data-chat="person5">
																		<div class="user">
																			<img src="img/user18.png" alt="Wafi Admin" />
																			<span class="status away"></span>
																		</div>
																		<p class="name-time">
																	...
																	<li class="person" data-chat="person3">
																		<div class="user">
																			<img src="img/user3.png" alt="Wafi Admin" />
																			<span class="status busy"></span>
																		</div>
																		<p class="name-time">
																	...
																	<li class="person" data-chat="person4">
																		<div class="user">
																			<img src="img/user20.png" alt="Wafi Admin" />
																			<span class="status offline"></span>
																		</div>
																		<p class="name-time">
																	...
																	<li class="person" data-chat="person5">
																		<div class="user">
																			<img src="img/user10.png" alt="Wafi Admin" />
																			<span class="status away"></span>
																		</div>
																		<p class="name-time">
