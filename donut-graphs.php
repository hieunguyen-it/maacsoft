...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Apex Donut Graphs</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="donut-graphs.html" class="current-page">Donut Charts</a>
										</li>
										<li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Donut Graph</li>
					</ol>
