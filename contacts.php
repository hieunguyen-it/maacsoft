...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Contacts</title>
					...
					<div class="row gutters">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="text-right mb-3">
								...
								<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addNewContact">Add New Contact</button>
										...
										<div class="modal-body">
											<form class="row gutters">
												...
												<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
													...
													<div class="form-group">
														<label for="userEmail">Email:</label>
														<input type="email" class="form-control" id="userEmail" value="aliko.catherine@wafi.com">
													</div>
													<div class="form-group">
														<label for="company">Company:</label>
														<input type="text" class="form-control" id="company" value="Wafi">
													</div>
												</div>
												<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
													<div class="form-group">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
							<figure class="user-card">
								<figcaption>
									...
									<img src="img/user14.png" alt="Wafi Admin" class="profile">
									<h5>Ali Sayed</h5>
									<ul class="list-group">
										<li class="list-group-item">ali.sayed@wafi.com</li>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
							<figure class="user-card">
								<figcaption>
									...
									<img src="img/user.png" alt="Wafi Admin" class="profile">
									<h5>Amy Hood</h5>
									<ul class="list-group">
										<li class="list-group-item">amy.hood@wafi.com</li>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
							<figure class="user-card">
								<figcaption>
									...
									<img src="img/user6.png" alt="Wafi Admin" class="profile">
									<h5>Den Klenkov</h5>
									<ul class="list-group">
										<li class="list-group-item">den.klenkov@wafi.com</li>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
							<figure class="user-card">
								<figcaption>
									...
									<img src="img/user22.png" alt="Wafi Admin" class="profile">
									<h5>Lily Jordan</h5>
									<ul class="list-group">
										<li class="list-group-item">lily.jordan@wafi.com</li>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
							<figure class="user-card">
								<figcaption>
									...
									<img src="img/user9.png" alt="Wafi Admin" class="profile">
									<h5>Harry Brown</h5>
									<ul class="list-group">
										<li class="list-group-item">harry.brown@wafi.com</li>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
							<figure class="user-card">
								<figcaption>
									...
									<img src="img/user20.png" alt="Wafi Admin" class="profile">
									<h5>Haley Bridges</h5>
									<ul class="list-group">
										<li class="list-group-item">haley.bridges@wafi.com</li>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
							<figure class="user-card">
								<figcaption>
									...
									<img src="img/user24.png" alt="Wafi Admin" class="profile">
									<h5>Meg Lewis</h5>
									<ul class="list-group">
										<li class="list-group-item">meg.lewis@wafi.com</li>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
							<figure class="user-card">
								<figcaption>
									...
									<img src="img/user18.png" alt="Wafi Admin" class="profile">
									<h5>Mohammed Chahin</h5>
									<ul class="list-group">
										<li class="list-group-item">mohammed.chahin@wafi.com</li>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
							<figure class="user-card">
								<figcaption>
									...
									<img src="img/user12.png" alt="Wafi Admin" class="profile">
									<h5>Roberts Hernandez</h5>
									<ul class="list-group">
										<li class="list-group-item">roberts.hernandez@wafi.com</li>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
							<figure class="user-card">
								<figcaption>
									...
									<img src="img/user10.png" alt="Wafi Admin" class="profile">
									<h5>Sullivan Rodriguez</h5>
									<ul class="list-group">
										<li class="list-group-item">sullivan.rodriguez@wafi.com</li>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
							<figure class="user-card">
								<figcaption>
									...
									<img src="img/user17.png" alt="Wafi Admin" class="profile">
									<h5>Zhenya Rynzhuk</h5>
									<ul class="list-group">
										<li class="list-group-item">zhenya.rynzhuk@wafi.com</li>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
							<figure class="user-card">
								<figcaption>
									...
									<img src="img/user21.png" alt="Wafi Admin" class="profile">
									<h5>Zuairia Zaman</h5>
									<ul class="list-group">
										<li class="list-group-item">zuairia.zaman@wafi.com</li>
