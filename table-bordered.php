...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Table Bordered</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="table-bordered.html" class="current-page">Table Bordered</a>
										</li>
										<li>
								...
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-bordered">
											...
											<tfoot>
												<tr>
													<td colspan="5" class="text-center">Data retrieved from <a href="" class="link">Wafi</a> and <a href="" class="link">Unify</a>.</td>
												</tr>
											</tfoot>
										</table>
									</div>
