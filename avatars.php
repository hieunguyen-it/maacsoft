...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>MAAC ANALYSIS - Avatars</title>
						...
						<ul>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										<li>
											<a href="avatars.html" class="current-page">Avatars</a>
										</li>
										<li>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="avatar-group">
										<div class="avatar xs">
											<img src="img/user.png" class="circle" alt="Wafi Admin" />
										</div>
										<div class="avatar sm">
											<img src="img/user.png" class="circle" alt="Wafi Admin" />
										</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="avatar-group flex-row-reverse">
										<div class="avatar xs">
											<img src="img/user22.png" class="half-circle" alt="Wafi Admin" />
										</div>
										<div class="avatar sm">
											<img src="img/user22.png" class="half-circle" alt="Wafi Admin" />
										</div>
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="avatar-group">
										<div class="avatar xs">
											<img src="img/user14.png" class="rounded" alt="Wafi Admin" />
										</div>
										<div class="avatar sm">
											<img src="img/user14.png" class="rounded" alt="Wafi Admin" />
										</div>
