...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Modals</title>
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
							...
							<div class="card">
								<div class="card-body text-center">
									...
									<!-- Button trigger modal -->
									<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#vCenterModal">
										Vertically Centered
									</button>
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							...
							<div class="card">
								<div class="card-body text-center">
									...
									<!-- Button trigger modal -->
									<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#footerCenterBtnsModal">
									...
									<!-- Button trigger modal -->
									<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#footerCenterIconsModal">
										Custom Footer Icons
									</button>
