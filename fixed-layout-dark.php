...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Fixed Layout Dark Version</title>
		...
		************ -->
		...
		<!-- Main css -->
		<link rel="stylesheet" href="css/main-dark-color.css">
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="fixed-layout-dark.html" class="current-page">Fixed Dark Version</a>
										</li>
										<li>
				...
				<div class="main-container fixed-height">
					...
					<div class="fixedBodyScroll">
						...
						<div class="content-wrapper">
							...
							<!-- ******************* 
								Placeholder for content - Place your code below.
							******************* -->
							<!-- Row start -->
								...
								<div class="col-12">
									...
									<div class="card">
										<div class="card-body">
											...
											<!-- Setting min height to enable scroll bar. This is just for your reference to see the scrollbar on right side. Please delete below div whe you add your code. -->
											<div style="min-height: 1200px" class="d-flex justify-content-center">
												
												<h5 class="mt-5">Scroll to see the scrollbar on right side.</h5>
