...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Default Dark Layout</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="default-layout.html" class="current-page">Default Light Version</a>
										</li>
										<li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Layout Light Version</li>
					</ol>
