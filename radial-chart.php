...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Apex Radial Graphs</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="radial-chart.html" class="current-page">Radial Graph</a>
										</li>
									</ul>
								</div>
							</li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Radial Graph</li>
					</ol>
