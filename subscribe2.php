...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Subscribe</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="subscribe2.html" class="current-page">Subscribe 2</a>
										</li>
									</ul>
								</div>
							</li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Subscribe 2</li>
					</ol>
					...
					<div class="row gutters justify-content-center">
						<div class="col-xl-7 col-lg-8 col-md-9 col-sm-10 col-12">
							...
							<div class="subscribe-form">
								<form>
									<h4 class="text-center mb-3">Keep up with The World</h4>
									<p class="text-center mb-4">Subscribe below to get captivating new stories, videos, and photos delivered to your email for free, plus special offers.</p>
									...
									<p><small>We will never share your e-mail address unless you allow us to do so.</small></p>
									<p><small>View our <a href="#">Privacy Policy</a>. Easy unsubscribe links are provided in every email.</small></p>
								</form>
								<!-- Subscribe Form ends -->
							</div>
