...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Calendar External Draggable Events</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="calendar-external-draggable.html" class="current-page">External Draggable</a>
										</li>
										<li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">External Draggable Events</li>
					</ol>
