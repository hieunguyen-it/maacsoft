...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Hover Gallery</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="gallery3.html" class="current-page">Gallery Hover</a>
										</li>
									</ul>
								</div>
							</li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Hover Gallery</li>
					</ol>
				...
				<div class="main-container">
								...
								<figure class="effect-3">
									...
									<figcaption>
										<div>
											...
											<p>Best Admin Template Design</p>
										</div>
										<a href="#">View more</a>
									</figcaption>
								</figure>
					...
					<div class="hover-gallery">
						<div class="row gutters">
								...
								<figure class="effect-1">
									...
									<figcaption>
										<div>
											...
											<p>Creative Admin Template Design</p>
										</div>
										<a href="#">View more</a>
									</figcaption>
								</figure>
							...
							<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12">
								<figure class="effect-1">
									<img src="img/img8.jpg" class="img-fluid" alt="Wafi Dashboard">
									<figcaption>
										<div>
											<h3>Hover Effect 1</h3>
											<p>Creative Admin Template Design</p>
