...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Toasts</title>
				...
				<div class="main-container">
					...
					<div class="row gutters">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
							<div class="toast primary" aria-live="assertive" aria-atomic="true" data-autohide="false">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
							<div class="toast info" aria-live="assertive" aria-atomic="true" data-autohide="false">
								<div class="toast-header">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
							<div class="toast danger" aria-live="assertive" aria-atomic="true" data-autohide="false">
								<div class="toast-header">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
							<div class="toast secondary" aria-live="assertive" aria-atomic="true" data-autohide="false">
								<div class="toast-header">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
							<div class="toast warning" aria-live="assertive" aria-atomic="true" data-autohide="false">
								<div class="toast-header">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
							<div class="toast success" aria-live="assertive" aria-atomic="true" data-autohide="false">
								<div class="toast-header">
							...
							<div class="card">
								...
								<div class="card-body">
									<div style="height: 250px;">
										...
										<div class="toast secondary pos-top-left" aria-live="assertive" aria-atomic="true" data-autohide="false">
											<div class="toast-header">
												<i class="icon-send"></i>
												<span class="title">Top Left</span>
										...
										<div class="toast primary pos-top-right" aria-live="assertive" aria-atomic="true" data-autohide="false">
											<div class="toast-header">
										...
										<div class="toast warning pos-btm-right" aria-live="assertive" aria-atomic="true" data-autohide="false">
											<div class="toast-header">
												<i class="icon-notifications"></i>
												<span class="title">Bottom Right</span>
										...
										<div class="toast info pos-btm-left" aria-live="assertive" aria-atomic="true" data-autohide="false">
											<div class="toast-header">
												<i class="icon-terrain"></i>
												<span class="title">Bottom Left</span>
					...
					<div class="row gutters">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Toast Horizontally and Vertically Centered</div>
								</div>
								<div class="card-body">										
										
									<!-- Flexbox container for aligning the toasts -->
									<div aria-live="polite" aria-atomic="true" class="d-flex justify-content-center align-items-center" style="height: 150px;">
										<!-- Then put toasts within -->
										<div class="toast secondary" role="alert" aria-live="assertive" aria-atomic="true" data-autohide="false">
											<div class="toast-header">
												<i class="icon-colours"></i>
												<span class="title">Centered Toast</span>
												<small>2 mins ago</small>
												<button type="button" class="close" data-dismiss="toast" aria-label="Close">
													<span aria-hidden="true">&times;</span>
												</button>
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							...
							<div class="card">
								...
								<div class="card-body">										
									...
									<div aria-live="polite" aria-atomic="true" class="d-flex justify-content-center align-items-center" style="height: 150px;">
										<!-- Then put toasts within -->
										<div class="toast info" role="alert" aria-live="assertive" aria-atomic="true" data-autohide="false">
											<div class="toast-header">
												<i class="icon-warning"></i>
												<span class="title">New Mail</span>
												<button type="button" class="close" data-dismiss="toast" aria-label="Close">
													<span aria-hidden="true">&times;</span>
												</button>
											</div>
											<div class="toast-body">
												<img src="img/user2.png" alt="Avatar" class="img-48 mr-2" />Hello, You have 10 new mails.
											</div>
										</div>
									</div>
