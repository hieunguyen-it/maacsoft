...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Apex Candlestick Graphs</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="candlestick.html" class="current-page">Candlestick</a>
										</li>
										<li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Candlestick Graph</li>
					</ol>
