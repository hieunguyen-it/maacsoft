...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Components - Progress Bars</title>
				...
				<div class="main-container">
					...
					<div class="row gutters">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Height</div>
								</div>
								<div class="card-body">
									<div class="progress">
					...
					<div class="row gutters">
						...
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Multiple Bars</div>
								</div>
								<div class="card-body">
									<div class="progress">
					...
					<div class="row gutters">
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Striped</div>
								</div>
								<div class="card-body">
									<div class="progress">
						...
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Striped Animated</div>
								</div>
								<div class="card-body">
									<div class="progress">
