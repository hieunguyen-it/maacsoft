...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>MAAC ANALYSIS - Accordion Large</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="accordion-lg.html" class="current-page">Accordion Large</a>
										</li>
									</ul>
								</div>
							</li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Accordion Large</li>
					</ol>
