...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Slim Sidebar Dark Version</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="slim-sidebar-dark.html" class="current-page">Slim Dark Version</a>
										</li>
										<li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Slim Sidebar Layout</li>
					</ol>
