...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Custom Alerts</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="custom-alerts.html" class="current-page">Custom Alerts</a>
										</li>
										<li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Custom Alerts</li>
					</ol>
						...
						<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
							<div class="alert-notify info">
								<div class="alert-notify-body">
									...
									<div class="alert-notify-title">Give your valuable feedback.<img src="img/notification-info.svg" alt=""></div>
						...
						<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
							<div class="alert-notify danger">
								<div class="alert-notify-body">
									...
									<div class="alert-notify-title">Give your valuable feedback.<img src="img/notification-danger.svg" alt=""></div>
									<div class="alert-notify-text">How likely are you to recommend Wafi Dashboard to your friends?</div>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
							<div class="alert-notify success">
								<div class="alert-notify-body">
									...
									<div class="alert-notify-title">Give your valuable feedback.<img src="img/notification-success.svg" alt=""></div>
									<div class="alert-notify-text">How likely are you to recommend Wafi Dashboard to your friends?</div>
								</div>
							</div>
						</div>
