						...
						<ul>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										<li>
											<a href="subscribe.html" class="current-page">Subscribe 1</a>
										</li>
										<li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Subscribe 1</li>
					</ol>
						...
						<div class="col-xl-6 col-lg-7 col-md-8 col-sm-9 col-12">
							...
							<div class="subscribe-form">
								<form>
									...
									<p class="text-center mb-3">Subscribe to our weekly Newsletter and stay tuned.</p>
									...
									<button type="button" id="submit" name="submit" class="btn btn-primary">Subscribe Form</button>
								</form>
								<!-- Subscribe Form ends -->
							</div>
