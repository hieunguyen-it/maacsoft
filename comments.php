...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Comments</title>
							...
							<li class="sidebar-dropdown">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="default-dark-layout.html">Default Dark Version</a>
										</li>
										<li>
											<a href="fixed-layout.html">Fixed Layout</a>
										</li>
										<li>
											<a href="fixed-layout-dark.html">Fixed Dark Version</a>
										</li>
										<li>
											<a href="slim-sidebar.html">Slim Layout</a>
										</li>
										<li>
											<a href="slim-sidebar-dark.html">Slim Dark Version</a>
										</li>
										<li>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="comments.html" class="current-page">User Comments</a>
										</li>
									</ul>
								</div>
							</li>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="media comments">
										<div class="mr-3">
											<a href="#">
												<span class="empty-avatar bg-success">JB</span>
											</a>
										</div>
										<div class="media-body">
											<h5 class="mt-0 media-heading">Jake Barford <span class="date">3 months ago</span></h5>
											<p>The grid right now is being handled by the Bootstrap grid system. You can get as many rows as you want, but as far as columns you are limited to what Bootstrap's framework can offer. 12 columns would make the images a bit too small I think, but you could easily do 6 columns by using col-md-2 instead of col-md-3!</p>
											<div class="comments-footer clearfix">
												<ul>
													<li>
														<a href="#" class="badge badge-info">694 ▲</a>
													</li>
													<li>
														<a href="#" class="badge badge-danger">21 ▼</a>
													</li>
													<li>
														<a href="#" class="badge badge-light">Reply</a>
													</li>
												</ul>
											</div>
											<div class="media mt-3">
												<div class="mr-3">
													<a href="#">
														<span class="empty-avatar bg-info">CS</span>
													</a>
												</div>
												<div class="media-body">
													<h5 class="mt-0 media-heading">Carlos Slim Helu <span class="date">2 months ago</span></h5>
													<p>I completely forgot about that.. Noob question, thank you I appreciate the response, very neat.</p>
													<div class="comments-footer clearfix">
														<ul>
															<li>
																<a href="#" class="badge badge-info">1050 ▲</a>
															</li>
															<li>
																<a href="#" class="badge badge-info">187 ▲</a>
															</li>
															<li>
																<a href="#" class="badge badge-light">Reply</a>
															</li>
													...
													<div class="clearfix comments-form mb-4">
													...
													<div class="media">
														<div class="mr-3">
															<a href="#">
																<span class="empty-avatar sm bg-danger">EM</span>
															</a>
														</div>
														<div class="media-body">
															<h5 class="mt-0 media-heading">Elon Musk<span class="date">2 months ago</span></h5>
															<p>Because I am filling the grid with images of different sizes, is there any way to center the images along a row axis so to speak, rather than each row sharing a top margin/padding/whatever?</p>
															<div class="comments-footer clearfix">
																<ul>
																	<li>
																		<a href="#" class="badge badge-info">1565 ▲</a>
																	</li>
																	<li>
																		<a href="#" class="badge badge-danger">76 ▼</a>
																	</li>
																	<li>
																		<a href="#" class="badge badge-light">Reply</a>
																	</li>
													...
													<div class="media">
														<div class="mr-3">
															<a href="#">
																<span class="empty-avatar sm bg-info">CL</span>
															</a>
														</div>
														<div class="media-body">
															<h5 class="mt-0 media-heading">Christine Lagarde<span class="date">1 month ago</span></h5>
															<p>Because I am filling the grid with images of different sizes, is there any way to center the images along a row axis so to speak, rather than each row sharing a top margin/padding/whatever?</p>
															<div class="comments-footer clearfix">
																<ul>
																	<li>
																		<a href="#" class="badge badge-light">652 ▲</a>
																	</li>
																	<li>
																		<a href="#" class="badge badge-danger">12 ▼</a>
																	</li>
																	<li>
																		<a href="#" class="badge badge-light">Reply</a>
																	</li>
													...
													<div class="media">
														<div class="mr-3">
															<a href="#">
																<span class="empty-avatar sm bg-success">GR</span>
															</a>
														</div>
														<div class="media-body">
															<h5 class="mt-0 media-heading">Ginni Rometty<span class="date">1 month ago</span></h5>
															<p>Because I am filling the grid with images of different sizes, is there any way to center the images along a row axis so to speak, rather than each row sharing a top margin/padding/whatever?</p>
															<div class="comments-footer clearfix">
																<ul>
																	<li>
											...
											<div class="media mt-3">
												<div class="mr-3">
													<a href="#">
														<span class="empty-avatar bg-pink">AH</span>
													</a>
												</div>
												<div class="media-body">
													<h5 class="mt-0 media-heading">Ali Hoseini<span class="date">20 days ago</span></h5>
													<p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
													<div class="comments-footer clearfix">
														<ul>
															<li>
																<a href="#" class="badge badge-light">112 ▲</a>
															</li>
															<li>
													...
													<div class="media mt-3">
														<div class="mr-3">
															<a href="#">
																<span class="empty-avatar sm bg-danger">CL</span>
															</a>
														</div>
														<div class="media-body">
															<h5 class="mt-0 media-heading">Christine Lagarde<span class="date">15 days ago</span></h5>
															<p>Because I am filling the grid with images of different sizes, is there any way to center the images along a row axis so to speak, rather than each row sharing a top margin/padding/whatever?</p>
															<div class="comments-footer clearfix">
																<ul>
																	<li>
																		<a href="#" class="badge badge-info">984 ▲</a>
																	</li>
																	<li>
													...
													<div class="media mt-3">
														<div class="mr-3">
															<a href="#">
																<span class="empty-avatar sm bg-info">AG</span>
															</a>
														</div>
														<div class="media-body">
															<h5 class="mt-0 media-heading">Antonio Guterres<span class="date">12 days ago</span></h5>
															<p>Because I am filling the grid with images of different sizes, is there any way to center the images along a row axis so to speak, rather than each row sharing a top margin/padding/whatever?</p>
															<div class="comments-footer clearfix">
																<ul>
																	<li>
																		<a href="#" class="badge badge-danger">653 ▲</a>
																	</li>
																	<li>
																		<a href="#" class="badge badge-info">35 ▼</a>
																	</li>
																	<li>
																		<a href="#" class="badge badge-light">Reply</a>
																	</li>
															...
															<div class="clearfix comments-form mb-5">
																<div class="form-group">
																	<textarea class="form-control" rows="3" placeholder="Write your comment..."></textarea>
																</div>
															</div>
											...
											<div class="media mt-3">
												<div class="mr-3">
													<a href="#">
														<span class="empty-avatar bg-orange">AT</span>
													</a>
												</div>
												<div class="media-body">
													<h5 class="mt-0 media-heading">Akio Toyoda<span class="date">7 days ago</span></h5>
													<p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
													<div class="comments-footer clearfix">
														<ul>
															<li>
																<a href="#" class="badge badge-success">652 ▲</a>
															</li>
															<li>
																<a href="#" class="badge badge-success">35 ▲</a>
															</li>
															<li>
																<a href="#" class="badge badge-light">Reply</a>
															</li>
											...
											<div class="media mt-3">
												<div class="mr-3">
													<a href="#">
														<span class="empty-avatar bg-success">MB</span>
													</a>
												</div>
												<div class="media-body">
													<h5 class="mt-0 media-heading">Mary Barra<span class="date">5 days ago</span></h5>
													<p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
													<div class="comments-footer clearfix">
														<ul>
															<li>
																<a href="#" class="badge badge-info">652 ▲</a>
															</li>
															<li>
																<a href="#" class="badge badge-info">35 ▲</a>
															</li>
											...
											<div class="media disabled mt-3">
												<div class="mr-3">
													<a href="#">
														<span class="empty-avatar bg-info">MD</span>
													</a>
												</div>
												<div class="media-body">
													<h5 class="mt-0 media-heading">Mario Draghi <span class="date">2 days ago</span></h5>
													<p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
													<div class="comments-footer clearfix">
														<ul>
															<li>
															...
															<li>
																<a href="#" class="badge badge-danger">35 ▲</a>
															</li>
															<li>
																<a href="#" class="badge badge-light">Reply</a>
															</li>
									...
									<div class="clearfix comments-form">
										<div class="form-group">
											<label class="control-label"><b>Write comment</b></label>
											<textarea class="form-control textarea" rows="3" placeholder="Write A Comment"></textarea>
										</div>
										<div class="form-group clearfix">
											<button class="btn btn-info float-right">Post Comment</button>
										</div>
									</div>
									<!-- Comments form end -->
								</div>
