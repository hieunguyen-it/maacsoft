...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Thumbnails</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="images.html" class="current-page">Thumbnails</a>
										</li>
										<li>
					...
					<div class="row gutters">
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
							...
							<div class="card">
								...
								<div class="card-body">
									<img src="img/bg2.jpeg" class="img-fluid" alt="Responsive image">
								</div>
							</div>
							<!-- Card end -->
						</div>
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
							...
							<div class="card">
								...
								<div class="card-body">
									<img src="img/bg3.jpeg" class="img-fluid" alt="Responsive image">
								</div>
							</div>
							<!-- Card end -->
						</div>
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
							...
							<div class="card">
								...
								<div class="card-body">
									<img src="img/bg4.jpeg" class="img-fluid" alt="Responsive image">
								</div>
							</div>
							<!-- Card end -->
						</div>
								...
								<div class="card-body">
									...
									<div class="row gutters">
										<div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
											<img src="img/img2.jpg" class="img-thumbnail" alt="Responsive image">
										</div>
										<div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
											<img src="img/img6.jpg" class="img-thumbnail" alt="Responsive image">
										</div>
										<div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
											<img src="img/img8.jpg" class="img-thumbnail" alt="Responsive image">
										</div>
										<div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
											<img src="img/img12.jpg" class="img-thumbnail" alt="Responsive image">
										</div>
									</div>
					...
					<div class="row gutters">
						<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12">
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<img src="img/img2.jpg" class="img-fluid  float-left" alt="Responsive image" style="max-width: 200px;">
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="text-center">
										<img src="img/img10.jpg" class="img-fluid" alt="Responsive image" style="max-width: 200px;">
									</div>
						...
						<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">
										Aligning Image Right
									</div>
								</div>
								<div class="card-body">

									<img src="img/img6.jpg" class="img-fluid float-right" alt="Responsive image" style="max-width: 200px;">
