...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Components - Pills</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="pills.html" class="current-page">Pills</a>
										</li>
									</ul>
								</div>
							</li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Pills</li>
					</ol>
				...
				<div class="main-container">
					...
					<div class="row gutters">
						...
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
							...
							<div class="card">
								<div class="card-body">
									<ul class="nav nav-pills secondary justify-content-center">
										<li>
											<a class="nav-link active" href="#">Active</a>
										</li>
										<li>
						...
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
							...
							<div class="card">
								<div class="card-body">
									<ul class="nav nav-pills secondary justify-content-end">
										<li>
											<a class="nav-link active" href="#">Active</a>
										</li>
										<li>
