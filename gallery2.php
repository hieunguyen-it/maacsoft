...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Thumbnail Gallery</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="gallery2.html" class="current-page">Gallery Thumbnail</a>
										</li>
										<li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Thumbnail Gallery</li>
					</ol>
					...
					<div class="photo-gallery">
						<div class="row no-gutters">
							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
								<div class="row no-gutters">
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-6 col-12">
										<img src="img/img9.jpg" class="img-fluid" alt="Wafi Dashboard">
									</div>
									<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
										<img src="img/img1.jpg" class="img-fluid" alt="Wafi Dashboard">
									</div>
									<div class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-12">
										<img src="img/img9.jpg" class="img-fluid" alt="Wafi Dashboard">
									</div>
									<div class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-12">
										<img src="img/img10.jpg" class="img-fluid" alt="Wafi Dashboard">
									</div>
									<div class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-12">
										<img src="img/img11.jpg" class="img-fluid" alt="Wafi Dashboard">
									</div>
								</div>
							</div>
							<div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12">
								<div class="row no-gutters">
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
										<img src="img/img5.jpg" class="img-fluid" alt="Wafi Dashboard">
									</div>
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
										<img src="img/img2.jpg" class="img-fluid" alt="Wafi Dashboard">
									</div>
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
										<img src="img/img3.jpg" class="img-fluid" alt="Wafi Dashboard">
									</div>
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
										<img src="img/img4.jpg" class="img-fluid" alt="Wafi Dashboard">
									</div>
								</div>
							</div>
							<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
								<div class="row no-gutters">
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-6 col-12">
										<img src="img/img6.jpg" class="img-fluid" alt="Wafi Dashboard">
									</div>
									<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
										<img src="img/img7.jpg" class="img-fluid" alt="Wafi Dashboard">
									</div>
									<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
										<img src="img/img12.jpg" class="img-fluid" alt="Wafi Dashboard">
									</div>
									<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
										<img src="img/img10.jpg" class="img-fluid" alt="Wafi Dashboard">
									</div>
