...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Timeline</title>
							...
							<div class="timeline">
								<div class="timeline-row">
									...
									<div class="timeline-content">
										...
										<h4>Admin theme!</h4>
										<p>Wafi Admin Dashboard contains C3 graphs, flot graphs, data tables, calendar, drag &amp; drop and ion slider.</p>
										<div class="thumbs">
											<div class="row gutters">
												<div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
													<img class="img-fluid rounded" src="img/img2.jpg" alt="Wafi Admin" />
												</div>
												<div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
													<img class="img-fluid rounded" src="img/img3.jpg" alt="Wafi Admin" />
												</div>
												<div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
													<img class="img-fluid rounded" src="img/img4.jpg" alt="Wafi Admin" />
												</div>
											</div>
										</div>
										<div class="">
								...
								<div class="timeline-row">
									...
									<div class="timeline-content">
										...
										<p>
											Wafi Admin Dashboard contains C3 graphs, flot graphs, data tables, calendar.
										</p>
										<div class="thumbs">
											<div class="row gutters">
												<div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
													<img class="img-fluid rounded" src="img/img5.jpg" alt="Wafi Admin" />
												</div>
												<div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
													<img class="img-fluid rounded" src="img/img9.jpg" alt="Wafi Admin" />
												</div>
												<div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
													<img class="img-fluid rounded" src="img/img7.jpg" alt="Wafi Admin" />
												</div>
											</div>
										</div>
										<div class="">
								...
								<div class="timeline-row">
									...
									<div class="timeline-content">
										...
										<p>Wafi Admin Dashboard contains C3 graphs, flot graphs, data tables, calendar, drag &amp; drop and ion slider.</p>
										<div>
											<span class="badge badge-pill">User Profile</span>
											<span class="badge badge-pill">Documents List</span>
										</div>
									</div>
								</div>
								...
								<div class="timeline-row">
									...
									<div class="timeline-content">
										<i class="icon-change_history"></i>
										<h4>Wafi Dashboard</h4>
										<p class="no-margin">Wafi Admin dashboard includes invoice, profile, tasks, gallery, projects, maintanence.</p>
										<div class="thumbs">
											<div class="row gutters">
												<div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
													<img class="img-fluid rounded" src="img/img3.jpg" alt="Wafi Admin" />
												...
												<div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
													<img class="img-fluid rounded" src="img/img11.jpg" alt="Wafi Admin" />
												</div>
												<div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
													<img class="img-fluid rounded" src="img/img8.jpg" alt="Wafi Admin" />
												</div>
											</div>
										</div>
										<div>
											<span class="badge badge-pill">Analytics</span>
											<span class="badge badge-pill">Contacts List</span>
										</div>
									</div>
								</div>
									...
									<div class="timeline-content">
										...
										<div class="thumbs">
											<div class="row gutters">
												...
												<div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
													<img class="img-fluid rounded" src="img/img10.jpg" alt="Wafi Admin" />
												</div>
											</div>
										</div>
										<div class="">
								...
								<div class="timeline-row">
									...
									<div class="timeline-content">
										...
										<div class="thumbs">
											<div class="row gutters">
												<div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
													<img class="img-fluid rounded" src="img/user.png" alt="Wafi Admin" />
												</div>
												<div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
													<img class="img-fluid rounded" src="img/user5.png" alt="Wafi Admin" />
												</div>
											</div>
										</div>
										<div class="">
											<span class="badge badge-pill">Project Management</span>
