...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Flot Graphs</title>
	...
	<body>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Flot Graphs</li>
					</ol>
					...
					<div class="row gutters">
						<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								...
								<div class="card-body">
									<div id="flotBarGraph" class="chart-height"></div>
								</div>
							</div>
						</div>
						<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Stacked Graph</div>
								</div>
								<div class="card-body">
									<div id="flotStackedGraph" class="chart-height"></div>
								</div>
							</div>
						</div>
						<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								...
								<div class="card-body">
									<div id="flotLineGraph" class="chart-height"></div>
								</div>
							</div>
						</div>
						<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								...
								<div class="card-body">
									<div id="flotAreaGraph" class="chart-height"></div>
								</div>
							</div>
						</div>
						<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Thresholds Graph</div>
								</div>
								<div class="card-body">
									<div id="flotThresholds" class="chart-height"></div>
								</div>
							</div>
						</div>
						<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								...
								<div class="card-body">
									<div id="flotPercentiles" class="chart-height"></div>
								</div>
							</div>
						</div>
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Crosshair Graph</div>
								</div>
								<div class="card-body">
									<div id="flotCrosshair" class="chart-height"></div>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
							<div class="card">
								...
								<div class="card-body">
									<div id="flotPieChart" class="chart-height"></div>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
							<div class="card">
								...
								<div class="card-body">
									<div id="flotDonutChart" class="chart-height"></div>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Pie Tilt Chart</div>
								</div>
								<div class="card-body">
									<div id="flotPieTiltChart" class="chart-height"></div>
								</div>
							</div>
						</div>
					</div>
		...
		************* -->
		...
		<script src="vendor/flot/jquery.flot.threshold.js"></script>
		<script src="vendor/flot/jquery.flot.fill-between.js"></script>
		<script src="vendor/flot/jquery.flot.crosshair.js"></script>
		<script src="vendor/flot/jquery.flot.pie.min.js"></script>
		<script src="vendor/flot/jquery.flot.tooltip.min.js"></script>

		<!-- Flot Custom Graphs -->
		<script  src="vendor/flot/custom/barGraph.js"></script>
		<script  src="vendor/flot/custom/stackedGraph.js"></script>
		<script  src="vendor/flot/custom/lineGraph.js"></script>
		<script  src="vendor/flot/custom/areaGraph.js"></script>
		<script  src="vendor/flot/custom/thresholdsGraph.js"></script>
		<script  src="vendor/flot/custom/percentilesGraph.js"></script>
		<script  src="vendor/flot/custom/crosshairGraph.js"></script>
		<script  src="vendor/flot/custom/pieChart.js"></script>
		<script  src="vendor/flot/custom/donutChart.js"></script>
		<script  src="vendor/flot/custom/pieTiltChart.js"></script>
