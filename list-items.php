...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Components - List Items</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="list-items.html" class="current-page">List Items</a>
										</li>
										<li>
										...
										<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
											<div class="list-group">
												...
												<a href="#" class="list-group-item list-group-item-action active">
													Simple list item link active
												</a>
												<a href="#" class="list-group-item list-group-item-action disabled">
													Simple list item link disabled
												</a>
											</div>
										</div>
										<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
											<div class="list-group">
												...
												<button type="button" class="list-group-item list-group-item-action active">List group item button active
												</button>
												<button type="button" class="list-group-item list-group-item-action disabled">List group item button disabled
												</button>
											</div>
										</div>
									</div>
