...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Calendar Daygrid View</title>
						...
						<ul>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										<li>
											<a href="calendar.html" class="current-page">Daygrid View</a>
										</li>
										<li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Calendar Daygrid</li>
					</ol>
