...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Apex Column Graphs</title>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										...
										<li>
											<a href="column-graphs.html" class="current-page">Column Charts</a>
										</li>
										<li>
			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Column Graph</li>
					</ol>
