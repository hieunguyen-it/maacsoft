...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Wafi Admin Template - Gallery</title>
						...
						<ul>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										<li>
											<a href="gallery.html" class="current-page">Gallery Slider</a>
										</li>
										<li>
					...
					<div class="baguetteBoxThree gallery">
						...
						<div class="row gutters">
							<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
								<a href="img/img1.jpg" class="effects">
									<img src="img/img1.jpg" class="img-fluid" alt="Wafi Admin">
									<div class="overlay">
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
								<a href="img/img2.jpg" class="effects">
									<img src="img/img2.jpg" class="img-fluid" alt="Wafi Admin">
									<div class="overlay">
										<span class="expand">+</span>
									</div>
								</a>
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
								<a href="img/img3.jpg" class="effects">
									<img src="img/img3.jpg" class="img-fluid" alt="Wafi Admin">
									<div class="overlay">
										<span class="expand">+</span>
									</div>
								</a>
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
								<a href="img/img4.jpg" class="effects">
									<img src="img/img4.jpg" class="img-fluid" alt="Wafi Admin">
									<div class="overlay">
										<span class="expand">+</span>
									</div>
								</a>
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
								<a href="img/img5.jpg" class="effects">
									<img src="img/img5.jpg" class="img-fluid" alt="Wafi Admin">
									<div class="overlay">
										<span class="expand">+</span>
									</div>
								</a>
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
								<a href="img/img6.jpg" class="effects">
									<img src="img/img6.jpg" class="img-fluid" alt="Wafi Admin">
									<div class="overlay">
										<span class="expand">+</span>
									</div>
								</a>
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
								<a href="img/img7.jpg" class="effects">
									<img src="img/img7.jpg" class="img-fluid" alt="Wafi Admin">
									<div class="overlay">
										<span class="expand">+</span>
									</div>
								</a>
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
								<a href="img/img8.jpg" class="effects">
									<img src="img/img8.jpg" class="img-fluid" alt="Wafi Admin">
									<div class="overlay">
										<span class="expand">+</span>
									</div>
								</a>
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
								<a href="img/img9.jpg" class="effects">
									<img src="img/img9.jpg" class="img-fluid" alt="Wafi Admin">
									<div class="overlay">
										<span class="expand">+</span>
									</div>
								</a>
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
								<a href="img/img10.jpg" class="effects">
									<img src="img/img10.jpg" class="img-fluid" alt="Wafi Admin">
									<div class="overlay">
										<span class="expand">+</span>
									</div>
								</a>
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
								<a href="img/img11.jpg" class="effects">
									<img src="img/img11.jpg" class="img-fluid" alt="Wafi Admin">
									<div class="overlay">
										<span class="expand">+</span>
									</div>
								</a>
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
								<a href="img/img12.jpg" class="effects">
									<img src="img/img12.jpg" class="img-fluid" alt="Wafi Admin">
									<div class="overlay">
										<span class="expand">+</span>
									</div>
								</a>
